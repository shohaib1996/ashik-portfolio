  ...
  const publications = [
    {
      ...
      authors:
        "Rahaman, A., Khalil, E., Miah, M. H., Ahmed, S., Hossen, A., & Khatun, S.",
    ...
    },
    {
      ...
      authors:
        "Rahaman, A., Hossain, S., Khalil, E., Akter, S., Roy, C. K., Saikat, P., Bala, P., & Amin, M. A.",
      journal: "Advanced Research Journal",
      date: "July 14, 2025",
      volume: "Vol. 8, No. 1",
    ...
    },
    {
      ...
      authors:
        "Khalil, E., Rafi, M. F., Reza, M. S., Sourov, M. I. A., Islam, M. T., Hossain, M. S., Rony, N., Zico, S. I., & Rahaman, A.",
      journal: "International Journal of Textile Engineering and Management",
      date: "July 17, 2026",
      volume: "Vol. 2, Issue 1",
      doi: "https://doi.org/10.63261/ijtem122",
      description:
        "Investigated the effect of air-nozzle pressure on 34 Ne CVC yarn produced using Murata Vortex Spinning (MVS 870). Identified 0.50 MPa as the optimal nozzle pressure, achieving the highest yarn tenacity (15.72 cN/tex), lowest unevenness (10.25%), and the best balance between yarn quality, waste generation, and energy efficiency.",
    },
  ];
